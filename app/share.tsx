...
export function SharePage() {
  ...
  if (error) return <main className="share-shell share-error"><div className="share-brand"><span className="brand-mark"><Sparkles size={18} /></span>象映笔记</div><div className="share-error-card"><h1>暂时无法打开这篇笔记</h1><p>{error}</p><Link className="text-link" to="/login"><ArrowLeft size={16} />返回登录</Link></div></main>;
